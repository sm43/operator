...
replace (
	github.com/secure-systems-lab/go-securesystemslib => github.com/secure-systems-lab/go-securesystemslib v0.5.0
	github.com/sigstore/sigstore => github.com/sigstore/sigstore v1.6.3
